  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            Driver.driver.FindElement(By.XPath("//div//a[@class='item'][contains(text(),'Sign In')]")).Click();

            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@placeholder='Email address']")).SendKeys("pawansheemar229@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[@placeholder='Password']")).SendKeys("Shermar1995");
            Thread.Sleep(1000);
